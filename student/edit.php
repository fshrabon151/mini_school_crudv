    ...
    <div id="wrapper" class="menuDisplayed">
        ...
        <div id="sidebar-wrapper">
            ...
            <ul class="sidebar-nav">
                ...
                <li><a href="add.php"><i class="fas fa-user-plus"></i> Add Student</a></li>
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <p class="page-title bg-info"><a href="#" class="btn btn-success" id="menu-toggle"><i class="fas fa-bars"></i> Menu </a> <span class="span-title"> <i class="fas fa-user-plus"></i></i> Edit Student</span></p>
